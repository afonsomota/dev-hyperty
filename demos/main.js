...
function hypertyDeployed(hyperty) {
  ...
  switch (hyperty.name) {
    ...
    case 'BraceletSensorReporter':
      template = 'BraceletSensor/braceletSensor';
      script =  'BraceletSensor/BraceletSensorReporter.js';
      break;

    case 'BraceletSensorObserver':
      template = 'BraceletSensor/braceletSensor';
      script =  'BraceletSensor/BraceletSensorObserver.js';
      break;
  }
